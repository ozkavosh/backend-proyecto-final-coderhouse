...
const isValidCartProduct = (product) => __awaiter(void 0, void 0, void 0, function* () {
    return yield cartProductSchema.validate(product, { abortEarly: false });
});
exports.default = isValidCartProduct;
