...
const isValidProduct = (product) => __awaiter(void 0, void 0, void 0, function* () {
    return yield productSchema.validate(product, { abortEarly: false });
});
exports.default = isValidProduct;
